========================================================================
    STATISCHE BIBLIOTHEK: serial_communication-Projektübersicht
========================================================================

Dieses serial_communication-Bibliotheksprojekt wurde vom 
Anwendungs-Assistenten für Sie erstellt.

Es wurden keine Quelldateien als Teil des Projekts erstellt.


serial_communication.vcxproj
...
serial_communication.vcxproj.filters
